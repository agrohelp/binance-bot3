...
def generate_signal(df: pd.DataFrame, cfg) -> Tuple[Optional[str], dict]:
    ...
    # (opcjonalnie można dodać SELL, na razie long‑only)
    # if not up_trend and macd_cross_down ... → SELL
